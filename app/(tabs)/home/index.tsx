...
import type { Movie } from "../../../src/api/movie";
  ...
  return (
    ...
    >
      <View className="px-6 pb-5 pt-4">
        <Text className="text-xl font-semibold uppercase tracking-widest text-[#FF8A3D]">
          My Movies
        </Text>
        <Text className="mt-1 text-3xl font-bold text-white">Início</Text>
